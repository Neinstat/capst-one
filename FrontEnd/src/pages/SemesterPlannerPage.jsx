      ...
      <div className="features-blue-container">
        ...
        {step === "result" && plannerData && (
          <div className="space-y-8 animate-scale-in">
            ...
            {plannerData.metadata.distribusi_sks && (
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Card Wajib */}
                  <div className="p-5 border rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100/20 dark:from-blue-950/20 dark:to-slate-900/40 border-blue-500/15 flex flex-col justify-between hover:border-blue-500/30 transition-all shadow-md">
                    <div>
                  ...
                  {/* Card WUN */}
                  <div className="p-5 border rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100/20 dark:from-emerald-950/20 dark:to-slate-900/40 border-emerald-500/15 flex flex-col justify-between hover:border-emerald-500/30 transition-all shadow-md">
                    <div>
                  ...
                  {/* Card Pilihan */}
                  <div className="p-5 border rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100/20 dark:from-purple-950/20 dark:to-slate-900/40 border-purple-500/15 flex flex-col justify-between hover:border-purple-500/30 transition-all shadow-md">
                    <div>
            ...
            <div className="bg-spark-card rounded-3xl border shadow-lg overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                {plannerData.plans[selectedPlan].schedule.map((semester, idx) => (
                  ...
                  >
                    <div className="bg-slate-50/60 dark:bg-slate-950/40 px-4 py-3 border-b border-spark-border flex justify-between items-center">
                      <div>
                      ...
                      <span className="text-xs font-bold px-2.5 py-1 bg-spark-card border rounded-lg text-spark-secondary shadow-sm">
