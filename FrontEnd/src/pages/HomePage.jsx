...
export default function HomePage() {
  ...
  return (
    <div className="w-full min-h-full lg:h-full flex flex-col lg:flex-row items-center lg:items-end select-none animate-scale-in text-spark-primary relative overflow-y-auto lg:overflow-hidden">
      


      {/* Left Side: Large Signpost Illustration touching the bottom and very close to the sidebar */}
      <div className="w-full lg:w-[45%] h-[35vh] sm:h-[45vh] lg:h-full flex items-end justify-center flex-shrink-0 relative z-10">
        <img
          src="/Palang Fitur SPARK DTI.png"
          alt="Palang Fitur SPARK DTI"
          className="h-full lg:h-[105%] w-auto max-w-full lg:max-w-none object-contain select-none filter drop-shadow-md hover:scale-[1.01] transition-transform duration-500 origin-bottom translate-x-0 lg:translate-x-12"
        />
      </div>

      {/* Right Side: Welcome Greeting and Spacious Guide Text */}
      <div className="w-full lg:flex-1 h-auto lg:h-full flex flex-col justify-center p-6 md:p-8 lg:pl-32 xl:pl-40 lg:pr-16 lg:py-14 text-left relative z-10">
